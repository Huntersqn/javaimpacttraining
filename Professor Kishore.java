//Professor Kishore wanted the kids to learn about Special numbers.
//(A two-digit number is said to be a special number if the sum of sum of its digits and 
//the product of its digits is equal to the number itself. For example, 19 is a special number.
